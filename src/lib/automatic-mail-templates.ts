...
export const AUTOMATIC_MAIL_TEMPLATES: AutomaticMailTemplate[] = [
  ...
  {
    key: "rad-match",
    label: "Radtour-Match gefunden",
    category: "Sonstiges",
    trigger: "Cron findet genug Mitfahrer:innen für ein Wochenende.",
    audience: "Teilnehmer:innen",
    file: "src/app/api/cron/daily-mail-jobs/route.ts",
  },
  {
    key: "rad-match-internal",
    label: "Radtour-Match (intern)",
    category: "Sonstiges",
    trigger: "Gleichzeitig mit dem Match, u. a. für Lunchpaket-Koordination.",
    audience: "Manager",
    file: "src/app/api/cron/daily-mail-jobs/route.ts",
  },
  {
    key: "rad-verify",
    label: "Radtour-Interesse bestätigen",
    category: "Sonstiges",
    trigger: "Anmeldung zu einer Radtour ohne bestehendes Konto.",
    audience: "Interessent:in",
    file: "src/lib/rad.ts",
  },
  {
    key: "birthday",
