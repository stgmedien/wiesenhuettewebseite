...
export const AUTOMATIC_MAIL_TEMPLATES: AutomaticMailTemplate[] = [
  ...
  {
    key: "kurkarten-ready",
    label: "Kurkarten sind da",
    category: "Buchung — Gast",
    trigger: "Sofort wenn Dana die fertige Kurkarten-PDF hochlädt — kein fester Tag, event-getrieben. Kurkarten + Feuerwehr-Meldeliste im Anhang.",
    audience: "Gast",
  ...
  },
  {
    ...
    category: "Buchung — Hüttenservice/intern",
    trigger: "T-7 — nur noch intern an Toni, keine parallele Gast-Mail mehr (die steckt jetzt in restzahlung-confirmed bei T-14). Ohne Kurkarten-Anhang — die bekommt Toni separat, siehe huettenwart-kurkarten-ready.",
    audience: "Toni Klauke + Brandenburg-Team",
    file: "src/app/api/cron/daily-mail-jobs/route.ts",
  },
  {
    key: "huettenwart-kurkarten-ready",
    label: "Kurkarten sind da — Hüttenservice",
    category: "Buchung — Hüttenservice/intern",
