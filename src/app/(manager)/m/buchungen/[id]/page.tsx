        ...
        <div className="space-y-6">
          ...
          {customer && b.status !== "storniert" && (
            <Section title="Digitaler Check-in (AVS-Kurkarten)">
              ...
              <KurkartenUploadForm
                bookingId={b.id}
                currentUrl={b.kurkartenPdfUrl}
                initialFeuerwehrNames={b.feuerwehrNames ?? []}
                initialFeuerwehrListeUrl={b.feuerwehrListePdfUrl}
              />
            </Section>
          )}
        </div>
        ...
        <aside>
          <Section title="Preisübersicht">
            ...
            <PersonsPriceEditor
              ...
              currentKurtaxePersons={b.adults + b.members + b.teachers}
            />
