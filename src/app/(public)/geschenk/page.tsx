...
> = {
  de: {
    ...
    lead: "Drei Generationen am Kachelofen, ein Wald voller Pfade, ein Lager voller Familienfreude. Du wählst den Betrag — wir kümmern uns um den Rest.",
  ...
  nl: {
    ...
    h1l2: "alweer sokken:",
    h1l3: "drie dagen hut.",
    lead: "Drie generaties bij de kachel, een bos vol paden, een slaapzaal vol familievreugde. Jij kiest het bedrag — wij regelen de rest.",
