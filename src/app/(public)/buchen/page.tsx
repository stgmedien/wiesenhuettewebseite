...
const PAGE_COPY: Record<Locale, { eyebrow: string; h1: string; lead: string; loggedIn: string; member: string }> = {
  de: {
    eyebrow: "Buchen",
    h1: "Wann kommt Ihr?",
    lead: "Mindestaufenthalt 2 Nächte, Mindestbelegung 15 Personen, maximal 33 Personen. Preise und Pauschalen werden live berechnet.",
  ...
  en: {
    ...
    lead: "Minimum stay 2 nights, minimum 15 guests, maximum 33. Prices and flat-rates are calculated live.",
  ...
  nl: {
    ...
    lead: "Minimaal 2 nachten, minimaal 15 personen, maximaal 33 personen. Prijzen en pakketten worden live berekend.",
