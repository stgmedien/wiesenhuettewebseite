...
export const PROJEKTE: Projekt[] = [
  ...
  },
  {
    ...
    nr: "WH-13",
    titel: "Eine neue Treppe führt zum Ölkeller.",
    untertitel: "Ölkeller-Treppe",
    darumGehts: "Der alte Ölkeller bekommt einen sicheren Zugang: eine neue Treppe hinunter.",
    ...
    danke: "Der erste Schritt zu allem, was danach im Ölkeller entsteht.",
    kontakt: "Ansprechpartner steht noch nicht fest",
  ...
  },
  {
    ...
    nr: "WH-14",
    titel: "Der Ölkeller wird zum Werkzeugschuppen.",
    untertitel: "Ölkeller-Instandsetzung",
    darumGehts:
      "Innen wird der alte Ölkeller zum kleinen Werkzeugschuppen fürs Gelände hergerichtet – mit Platz für Spitzhacken und Co.",
    brauchenWir: [
