...
export const FAHRT_MODULE: FahrtModul[] = [
  ...
  },
  {
    ...
    badge: "schule",
    badgeNote: "Über die Schule · Teamer:innen auf Anfrage",
    vision:
      "Angeleitete Kooperations-, Vertrauens- und Kennenlernformate — zugeschnitten auf die jeweilige Gruppe und ihr Ziel. Das Gelände liefert die Bühne: Bewegungshang, Feuerstelle, Wald ringsum.",
    tagesanteil: 0.5,
    dauer: "flexibel — Einheit, Halbtag oder über die Fahrt verteilt",
    gruppe: "klassenweise; größere Gruppen in Teilgruppen",
    kosten: "nach Aufwand / Teamer:innen-Honorar — auf Anfrage",
    wayfind: "Direkt an der Hütte & auf dem Gelände",
    vorlauf: "Wir bauen gerade erst einen Teamer:innen-Pool auf — je früher die Anfrage, desto besser.",
  },
  {
    id: "winterberg",
