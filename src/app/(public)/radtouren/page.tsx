...
const COPY: Record<Locale, Copy> = {
  de: {
    ...
    form: {
      ...
      consentLabel: "Ich bin einverstanden, dass meine E-Mail-Adresse beim Zustandekommen einer Gruppe (ab 8 Personen) mit den anderen Teilnehmer:innen dieses Zeitraums geteilt wird, damit wir uns abstimmen können. Austragen jederzeit per Mail an skifreunde@wiesenhuette.de.",
    ...
    status: {
      ...
      mailfehler: "Dein Eintrag ist gespeichert, aber die Bestätigungs-Mail konnte nicht gesendet werden. Bitte versuch es später erneut oder schreib an skifreunde@wiesenhuette.de.",
    },
  },
  en: {
    ...
    form: {
      ...
      consentLabel: "I agree that my email address will be shared with the other participants of a matched weekend (8+ people) so we can coordinate. Opt out anytime via skifreunde@wiesenhuette.de.",
    ...
    status: {
      ...
      mailfehler: "Your entry is saved, but the confirmation email could not be sent. Please try again later or write to skifreunde@wiesenhuette.de.",
    },
  },
  nl: {
    ...
    form: {
      ...
      consentLabel: "Ik ga ermee akkoord dat mijn e-mailadres bij een match (8+ personen) wordt gedeeld met de andere deelnemers van dat weekend, zodat we kunnen afstemmen. Uitschrijven kan altijd via skifreunde@wiesenhuette.de.",
    ...
    status: {
      ...
      mailfehler: "Je inschrijving is opgeslagen, maar de bevestigingsmail kon niet worden verzonden. Probeer het later opnieuw of mail naar skifreunde@wiesenhuette.de.",
    },
  },
};
